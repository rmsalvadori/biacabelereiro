...
procedure TFrmBuscaClientes.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmBuscaClientes.DBGrid1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmBuscaClientes.DBGrid1TitleClick(Column: TColumn);
var
  tabela: TFDTable;
begin
  tabela := dm.cliente;
...
procedure TFrmBuscaClientes.Edit1Change(Sender: TObject);
begin
...
procedure TFrmBuscaClientes.Edit1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = VK_DOWN then
  begin
...
procedure TFrmBuscaClientes.FormKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = VK_F2 then
    Edit1.SetFocus;
...
procedure TFrmBuscaClientes.TBSelecionarClick(Sender: TObject);
begin
  selecionado := DataSource1.DataSet.FieldByName('id').AsInteger;
  ModalResult := mrOk;
end;
